...
plt.show()
"""
conv_layer1 = Conv(num_filters=3, kernel_size=(3, 3), padding=1, stride=1, log=False)
pool_layer1 = MaxPool()
conv_layer2 = Conv(num_filters=3, kernel_size=(3, 3), padding=1, stride=1, log=False)
pool_layer2 = MaxPool()
